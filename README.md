...
For drawing recatangular boxes around circular cross section, we are using [Hough Circle Algo](https://docs.opencv.org/master/da/d53/tutorial_py_houghcircles.html)
